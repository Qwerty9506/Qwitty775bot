...
LANG = {
    ...
    "msg_rules_text": "📜 **Правила использования бота:**\n\n1. Бот работает через юзербота (Pyrogram).\n2. Все данные хранятся в защищенной облачной БД Supabase.\n3. Бот работает 24/7 без ограничений и слежки.\n\n_БЕЗ ЛИМИТОВ. БЕЗ ТОРМОЗОВ._",
